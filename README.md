...
| [2. Cách tích hợp thư viện vào Java project bằng command line (hiện tại)](https://github.com/anaconda875/command-line/tree/external-lib) | [external-lib](https://github.com/anaconda875/command-line/tree/external-lib) |                                       |
...
cd command-line
```
3. Checkout branch `external-lib`
```powershell
git checkout external-lib
```
